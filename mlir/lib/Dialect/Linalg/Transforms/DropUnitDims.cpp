...
struct RankReducedExtractSliceOp
  ...
  LogicalResult matchAndRewrite(tensor::ExtractSliceOp sliceOp,
    ...
    auto reassociation = getReassociationMapForFoldingUnitDims(resultType.getShape());
    if (!reassociation ||
...
struct RankReducedInsertSliceOp : public OpRewritePattern<InsertOpTy> {
  ...
  LogicalResult matchAndRewrite(InsertOpTy insertSliceOp,
    ...
    auto reassociation = getReassociationMapForFoldingUnitDims(sourceType.getShape());
    if (!reassociation ||
